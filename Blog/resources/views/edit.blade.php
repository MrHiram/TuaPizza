        ...
        <div class="container pr-0">
            ...
            <div id="receipt" class="container">
                <form id="formIngredient" class="mb-0">
                    ...
                    <label class="main-text" for="z_index">Escoja la capa del 1 al 20</label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                        <span class="input-group-text">Orden</span>
                        </div>
                        <input id="z_index" type="number" name="z_index" class="form-control" step="1" min="1" max="20" value="{{$ingredient->z_index}}"  required>
                    </div>
